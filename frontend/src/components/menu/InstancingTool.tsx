...
interface InstancingToolProps {
  cesiumViewerRef: React.RefObject<CesiumViewerRef | null>;
}

/**
 * Instancing 工具组件
 * 从 InstancingPanel 中提取的功能
 */
function InstancingTool({ cesiumViewerRef }: InstancingToolProps) {
  const {
    isLoading,
    setIsLoading,
    infoMessage,
